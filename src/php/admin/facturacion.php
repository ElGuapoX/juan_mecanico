...
<header>
    ...
    <a href="admin.php"><img src="../../images/con_fondo-removebg-preview (1).png" alt="Logo" class="logo"></a>
                ...
                <tbody>
                    <?php foreach ($todos_clientes as $cliente): ?>
                        <tr>
                            ...
                            <td>
                                <a href="formulariofactura.php?id_cliente=<?php echo urlencode($cliente['ID_CLIENTE']); ?>" class="btn">Facturación</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
